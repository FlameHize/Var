...
using var::string;
using var::net::Buffer;

TEST(Buffer, test_buffer_append_retrieve)
{
  Buffer buf;
...
TEST(Buffer, test_buffer_inside_grow)
{
  Buffer buf;
...
TEST(Buffer, test_buffer_shrink)
{
  Buffer buf;
...
TEST(Buffer, test_buffer_prepend)
{
  Buffer buf;
...
TEST(Buffer, test_buffer_read_int)
{
  Buffer buf;
  buf.append("HTTP");
...
TEST(Buffer,test_buffer_find_EOL)
{
  Buffer buf;
