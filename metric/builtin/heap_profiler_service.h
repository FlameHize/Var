...
#ifndef VAR_BUILTIN_HEAP_PROFILER_SERVICE_H
#define VAR_BUILTIN_HEAP_PROFILER_SERVICE_H

#include "metric/builtin/service.h"

namespace var {

class HeapProfilerService : public Service {
public:
    HeapProfilerService();
    ~HeapProfilerService();
...
#endif // VAR_BUILTIN_HEAP_PROFILER_SERVICE_H